...
public class TugaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "LPAREN", "RPAREN", "NOT", "MULT", "DIV", "MOD", "SUM", 
			"SUB", "LESS", "GREATER", "LESS_EQ", "GREATER_EQ", "EQUALS", "N_EQUALS", 
			"AND", "OR", "END_INST", "INT", "DOUBLE", "STRING", "TRUE", "FALSE", 
			"INT_TYPE", "DOUBLE_TYPE", "STRING_TYPE", "BOOLEAN_TYPE", "VAR", "WS", 
